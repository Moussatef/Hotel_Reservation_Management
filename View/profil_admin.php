                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                                <div class="card w-75">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span class="badge rounded-pill bg-warning  float-end">DELETED</span>
                                        <hr>
                                        ...
                                        <a href="../controller/controller.php?update= <?php echo $row["id_bien"]; ?>" class="btn rounded-pill btn-success float-end ms-2"><i class="fa fa-retweet" aria-hidden="true"></i></a>
